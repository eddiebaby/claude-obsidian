...
- [[DragonScale Memory]] — proposed memory-layer spec inspired by the Heighway dragon curve; fold operator, content-addressable paths, semantic tiling, boundary-first attention (status: proposed)
