...
- [[DragonScale Memory]] — proposed memory-layer spec inspired by the Heighway dragon curve; fold operator, deterministic page addresses, semantic tiling, boundary-first attention (status: proposed)
