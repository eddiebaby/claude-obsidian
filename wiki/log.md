...
- Updated: [[dream-threads]] — three new table rows; Thread 4 (**first consummated anima union** — she initiates and completes it, but in the ex's house, foreign and stuck; new marker: the anima in a house the ego *owns*); Thread 8 (grip split by domain: vocational **executed** — offer → keys → *signed up*, the series' first completed commitment; relational still fumbled — stalled car, refused talk, parked surveillance of the ex's house; inner-work receptive but mismanaged — sees the bird land, over-fires the thermostat); Thread 6 (first wholly positive employer-figure, and she's feminine — the farm woman provides, hires, hands over the keys; second consecutive police-free night; caution: the surveillance *method* survived the court by migrating into the ego — reconnaissance of his own past); Thread 3 (snow returns fresh and the **cat is in it, joyfully** — the instinct is in the element; refined marker: the *ego* joins the element himself); Thread 2 (fourth interface image: the **keyring** — first one that comes with a job attached; watch for a delivery actually made)
- New watch-list image: **bird perched on the cat's head** — first spontaneous spirit–instinct conjunction in the series, outdoors, unmanaged, while the ego overheats the house from inside
- Vocational note recorded on the farm page: courier for a real local farm = distribution of existing local value — the consulting business in dream-shorthand, at corner-store scale; the dozen saved eggs (varied, some ostrich-huge) read as the current project-potentials, already set aside for him
- Open associations to fill: which ex (and the affect at the stall moment); the farm's real name + the woman's waking character; who the pajama/suit couple resemble; the bird's species; confirm the garbled heat line ("can't have the heat" vs. self-set thermostat — changes the furnace reading from over-firing to a vessel that won't regulate)
- Associations partially filled same day: heat line **confirmed self-set** (over-firing reading stands); farm woman characterized — real, staff at the farm down the street, very pleasant, always nice to see (waking staff / dream employer: the psyche promotes her on quality of contact, not worldly position); no day residue recalled. Still open: which ex + stall affect; the avoided conversation; the farm's name; the dozen eggs named; the pajama/suit couple; the bird's species
- Process note: the dream session filed all three pages + [[dream-threads]] but was interrupted before log/hot updates and commit; bookkeeping completed by the following session

## 2026-07-11 | ingest | Batch: 4 JOAP 2023 papers + 1 practitioner paper (Charura-Bushell, Jones, Osterhold, Ajuonuma, Turchin)
- Sources: `.raw/JOAP-68-1-Charura-Bushell-Duoethnographic-Colonialism.pdf`, `.raw/JOAP-68-4-Jones-Dialectics-Sign-Symbol-Archetype.pdf`, `.raw/JOAP-68-4-Osterhold-Chasing-the-Numinous.pdf`, `.raw/JOAP-68-5-Ajuonuma-Alchemical-Oedipus.pdf`, `.raw/active_imagination_lucd_dreamingn.pdf`
- Summaries: [[JOAP-68-1-Charura-Bushell-Duoethnographic-Colonialism]] (c-000075), [[jones2023-dialectics-sign-symbol-archetype]] (c-000087), [[osterhold2023-chasing-the-numinous]] (c-000095), [[ajuonuma2023-alchemical-oedipus]] (c-000100), [[turchin-active-imagination-lucid-dreaming]] (c-000112)
- Pages created (41, addresses c-000075–c-000117): 5 sources; concepts [[Colonizer Archetype]], [[Ethnic Shadow]], [[Cultural Layer of the Psyche]], [[Duoethnography]], [[ipso facto]], [[mundus imaginalis]], [[Sign and Symbol]], [[Peircean Semiotics]], [[Utterance (Bakhtin)]], [[a-priori]], [[Hungry Ghost]], [[Psychedelic Renaissance]], [[Kings Renewal Parable]], [[Visio Arislei]], [[Complementary Oedipus Complex]], [[Pharmakon]], [[coniunctio-oppositorum]], [[rex-marinus]], [[filius-regius]], [[lapis-exilis]], [[Lucid Dreaming]], [[Aphantasia]], [[Mental Screen]]; entities [[Divine Charura]], [[Stephen Bushell]], [[Andrew Samuels]], [[Sam Kimbles]], [[Namfundo Lily-Rose Mlisa]], [[Raya Jones]], [[Charles Sanders Peirce]], [[Mikhail Bakhtin]], [[Helge Michael Osterhold]], [[Gisele Fernandes-Osterhold]], [[Reginald Ajuonuma]], [[George Devereux]], [[Karl Kerenyi]], [[Alexey Turchin]], [[Stephen LaBerge]]
- Pages updated: [[Archetype]], [[Numinous Experience]], [[Cultural Complex]], [[Inflation-Jungian]], [[Religious Function of the Psyche]], [[Active Imagination]], [[Dream Recall]], [[Mercurius]], [[Coniunctio]], [[Nigredo]], [[Lapis-Philosophorum]], [[Ubuntu]], [[Joseph-L-Henderson]] (+ contradiction callout), plus sources/concepts/entities `_index.md`, `depth-psychology.md`, `index.md`, `hot.md`
- **Latin-phrase rule honoured**: [[ipso facto]], [[mundus imaginalis]] (Charura-Bushell); [[a-priori]] (Jones); [[coniunctio-oppositorum]], [[rex-marinus]], [[filius-regius]], [[lapis-exilis]] (Ajuonuma) all got full concept pages, not stubs
- **Concurrency incident — race, not just collision.** 5 wiki-ingest agents ran in parallel, all instructed to update `concepts/_index.md`, `entities/_index.md`, `sources/_index.md` per their standard process. The per-file `wiki-lock` serializes *writes* but agents read-then-wrote without re-reading immediately before acquiring the lock, so 4 of 5 agents' index insertions were silently overwritten by whichever agent wrote last — only Charura-Bushell's entries survived in all three index files. The underlying wiki pages themselves were unaffected (each agent wrote its own distinct page set). Orchestrator manually reconciled all missing index entries after the fact by diffing each source page's own "New Concepts/Entities" section against the live index files. **Process gap, not content-loss** — but worth hardening: batch ingest agents should not all be told to touch the same shared index files independently; a future version should have agents report their new-page lists back to the orchestrator, which does one serialized index-merge pass, rather than 5-way concurrent writes to 3 shared files.
- **Two agents hit their turn budget before finishing.** Ajuonuma's agent listed 5 new Latin-phrase pages in its source page but only wrote 2 ([[coniunctio-oppositorum]], [[rex-marinus]]) before running out of turns; orchestrator wrote the missing [[filius-regius]] and [[lapis-exilis]] from existing CW13 (Melusina/filius regius, pars. 181-184) and CW14 (lapis exilis, pars. 147-153) material already in the vault. A third listed term, *opus contra naturam*, was never actually quoted or used anywhere in the agent's extracted text — removed the dangling reference rather than fabricate a page for a phrase the source transcript doesn't substantiate.
- **Pre-existing wikilink hygiene fixed in passing**: three filename/wikilink-text mismatches (space vs. hyphen/underscore — `[[James Hillman]]` vs `James-Hillman.md`, `[[Deconstructing Archetype Theory]]` vs `Deconstructing-Archetype-Theory.md`, `[[Symbol and Myth]]` vs `Symbol_and_Myth.md`) were surfaced by the new sources linking to them. Fixed via `aliases:` frontmatter on the three target pages rather than rewriting every citing page vault-wide.
- **Cross-source connections**: Charura-Bushell and Osterhold both run their material through [[Cultural Complex]] (Singer & Kimbles) — same theoretical machine, colonial/racial shadow vs. psychedelic-renaissance shadow. Ajuonuma, Osterhold, and Charura-Bushell are three independent worked examples this batch of Jungian amplification applied beyond individual dream material (myth, Buddhist cosmology, socio-historical pattern respectively) — worth a future [[Amplification]] page update tying them together explicitly. Jones's semiotic skepticism about archetype-as-explanation sits in useful tension with Osterhold's un-interrogated use of "the Hungry Ghost archetype" as explanatory machinery — not a formal contradiction (different papers, not in dialogue), but an editorial connection worth having ready if the archetype-epistemology question ever surfaces in the individuation-app design.
- **Known gap surfaced, not fixed**: "the transcendent function" is referenced by 16+ existing vault pages (Charura-Bushell's new page among them) but has never had its own concept page — the original CW8 ingest only TOC-sampled the essay (¶131-193). Left as a dangling wikilink rather than fabricated from general knowledge; candidate for a dedicated future ingest of that specific essay.
- **Out of scope, flagged for Scott**: `.raw/JOAP-68-5-Zeng-I-Ching-Jungian-Application.pdf` appeared in `.raw/` mid-run (not one of the 5 requested files, likely dropped by a concurrent process) — left untouched.
- Addresses: c-000075–c-000117 allocated manually (flock still broken on Windows); counter verified against highest in-use address (c-000074) before allocation, no collision this time; counter now 118
